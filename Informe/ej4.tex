...
\begin{table}[h!]
	...
	\begin{tabular}{c c c c c }
		...
		\hline \\
		$R_1$ & $0$& $1$ & $0$& $-\frac{1}{R_4}$\\ \\
		$R_2$ & $-\frac{1}{2}\cdot R_5R_3C_1C_2$& $-\frac{1}{2}$ & $0$& $0$\\ \\
		$R_3$ & $-\frac{1}{2}\cdot R_2R_5C_1C_2$& $-\frac{1}{2}$ & $-\frac{1}{R_4}$&$0$ \\ \\
		$R_4$ & $0$& $0$& $\frac{R_3}{R_4^2}$ &$\frac{R_1}{R_4^2}$ \\ \\
		$R_5$ & $-\frac{1}{2}\cdot R_2R_3C_1C_2$&$-\frac{1}{2}$ & $0$&$0$ \\ \\
		$R_6$ & $\frac{1}{2}$& $\frac{1}{2}$ & $0$& $0$ \\ \\
		$C_1$ & $-\frac{1}{2}\cdot R_2R_3R_5C_2$& $\frac{1}{2}$ & $0$& $0$\\ \\
		$C_2$ & $-\frac{1}{2}\cdot R_2R_3R_5C_1$& $-\frac{1}{2}$ & $0$ & $0$\\ \\
		\hline
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{c c c c c }
		...
		$R_3$ & $-\frac{1}{2}$ & $-\frac{1}{2}$ & $-\frac{1}{R_4}$ & $0$ \\ \\
		$R_4$ & $0$ & $0$ & $\frac{R_3}{R_4^2}$ & $\frac{R_1}{R_4^2}$ \\ \\
		$R_5$ & $\frac{1}{2}$ & $\frac{1}{2}$ & $0$ & $0$ \\ \\
		$R_6$ & $-\frac{1}{2}$ & $-\frac{1}{2}$ & $0$ & $0$ \\ \\
		$C_1$ & $-\frac{1}{2} $ & ${\frac {1}{{\it R1}} \left( {\it R1}\,\sqrt {{\frac {{\it R5}}{{\it C1
						}\,{\it C2}\,{\it R2}\,{\it R3}\,{\it R6}}}}-\frac{1}{2}\,{\frac {{\it R1}\,{
						\it R5}}{{\it C1}\,{\it C2}\,{\it R2}\,{\it R3}\,{\it R6}}{\frac {1}{
						\sqrt {{\frac {{\it R5}}{{\it C1}\,{\it C2}\,{\it R2}\,{\it R3}\,{\it 
										R6}}}}}}} \right) {\frac {1}{\sqrt {{\frac {{\it R5}}{{\it C1}\,{\it 
									C2}\,{\it R2}\,{\it R3}\,{\it R6}}}}}}}
		$ & $0$ & $0$\\ \\
