...
\end{figure}
 ...
 \begin{figure}[H] %!ht
	\centering	\includegraphics[width=12cm,height=12cm,keepaspectratio]{../EJ4/graficos/bode_amplitud_zoom.png}
	\caption{Diagrama de Bode: Amplitud - Detalle en el pico de notch.}
	\label{bode_mod_zoom}
\end{figure}
